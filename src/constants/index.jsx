...
export const HOW_IT_WORKS_CONTENT = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Unlock revenue streams by adding subscriptions, donations, and sponsorships to your stream.',
      imageSrc: monetizeImage,
      imageAlt: 'Monetization',
    },
    {
      title: 'Automate Your Workflows',
      description: 'Use advanced automation tools to manage your schedule, alerts, and promotions effortlessly.',
...
export const KEY_FEATURES_CONTENT = {
  ...
  sectionDescription: 'Everything you need to enhance your streaming experience, all in one place.',
  features: [
    {
      id: 1,
      icon: <RiBarChart2Line className="w-8 h-8" />,
      title: 'Real-Time Stream Analytics',
      description: 'Track your audience engagement, viewer count, and performance in real-time.',
    },
    {
      id: 2,
      icon: <RiSettings2Line className="w-8 h-8" />,
      title: 'Automated Stream Management',
      description: 'Set up automated alerts, stream schedules, and more with ease.',
    },
    {
      id: 3,
      icon: <RiTeamLine className="w-8 h-8" />,
      title: 'Audience Engagement Tools',
      description: 'Interact with your audience through custom alerts, chat integrations, and giveaways.',
    },
    {
      id: 4,
      icon: <RiTwitchLine className="w-8 h-8" />,
      title: 'Twitch Integration',
      description: 'Seamlessly connect with Twitch to automate alerts, manage subscribers, and track donations.',
    },
    {
      id: 5,
      icon: <RiYoutubeLine className="w-8 h-8" />,
      title: 'YouTube Streaming Support',
      description: 'Go live on YouTube with built-in tools for managing chats, subscribers, and more.',
    },
    {
      id: 6,
      icon: <RiCalendarLine className="w-8 h-8" />,
      title: 'Schedule Streams',
      description: 'Plan and schedule your streams ahead of time, with reminders sent to your audience.',
    },
  ],
};
  ...
  plans: [
    {
      name: 'Basic',
      price: '$9.99/month',
      description: 'Perfect for beginners just starting their streaming journey.',
      features: ['Basic analytics', 'Custom overlays', 'Viewer engagement tools', 'Stream up to 720p'],
    },
    {
      name: 'Pro',
      price: '$19.99/month',
      description: 'For streamers who want more advanced tools to grow their audience.',
      features: [
        'Advanced analytics',
    ...
    },
    {
      name: 'Elite',
      price: '$49.99/month',
      description: 'For professional streamers who need cutting-edge tools and insights.',
      features: [
